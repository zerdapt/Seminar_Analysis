...
To illustrate these quantitative findings with qualitative evidence, Table \ref{tab:examples} provides examples from the analyzed documentation. To highlight the deifference between the liability oriented Major Tech companies as well as the attemts to environemtal reportings seen in the independent projects.
